 ...
 *
 *
 * This file is a fork of OpenJDK jdk.internal.net.http.common.SequentialScheduler
 *
...
package org.aio.core2.internal.concurrent;
...
public final class SequentialScheduler {
    ...
    /**
     * A task that runs its main loop with a Lock to provide

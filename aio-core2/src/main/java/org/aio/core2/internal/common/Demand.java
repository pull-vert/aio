 ...
 *
 *
 * This file is a fork of OpenJDK jdk.internal.net.http.common.Demand
 *
...
public final class Demand {
    ...
    public boolean increase(long n) {
        ...
        var prev = val.getAndAccumulate(n, (p, i) -> p + i < 0 ? Long.MAX_VALUE : p + i);
        return prev == 0;
    }

...
public final class CoreUtils {
    ...
    public static String stackTrace(Throwable t) {
        ...
        String s;
        try {
            var p = new PrintStream(bos, true, "US-ASCII");
            t.printStackTrace(p);
    ...
    public static int copy(ByteBuffer src, ByteBuffer dst) {
        var srcLen = src.remaining();
        var dstLen = dst.remaining();
        if (srcLen > dstLen) {
            var diff = srcLen - dstLen;
            var limit = src.limit();
    ...
    public static ByteBuffer copy(ByteBuffer src) {
        var dst = ByteBuffer.allocate(src.remaining());
        dst.put(src);
        dst.flip();
        return dst;
    }
    ...
    public static ByteBuffer sliceWithLimitedCapacity(ByteBuffer buffer, int amount) {
        final var index = buffer.position() + amount;
